...
# Modify the final layer to match the number of classes in your dataset and include Dropout
num_ftrs = model.fc.in_features
model.fc = nn.Sequential(
    nn.Dropout(p=0.2),  # 50% dropout rate
...
# Add scheduler for cosine annealing
...
# Train the model with cosine annealing, dropout, and L2 regularization
